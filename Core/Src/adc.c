...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA8     ------> ADC1_IN8
    */
    GPIO_InitStruct.Pin = SENSE_5V_Pin|BSPS_FRONT_Pin|BSPS_REAR_Pin|BOTS_Pin
                          |BPPS_Pin|APPS_3_Pin|APPS_2_Pin|APPS_1_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA8     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOA, SENSE_5V_Pin|BSPS_FRONT_Pin|BSPS_REAR_Pin|BOTS_Pin
                          |BPPS_Pin|APPS_3_Pin|APPS_2_Pin|APPS_1_Pin);
