 ...
 * 
 * \return float in range [0,1], if it gets from the sensors a value outside the range, it truncates to 0 or 1 and sets a flag checked with brake_is_percentage_valid
 */
